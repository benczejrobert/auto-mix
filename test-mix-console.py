...
class SignalProcessor:
    ...
    def _create_all_proc_vars_combinations(self, dict_proc_vars_multiple_filter_type_names, root_filename,
        ...
        :param cr_proc_number_of_filters: If not None, this restricts the possible combinations to the subset containing exactly number_of_filters filters
        :param dict_proc_vars_multiple_filter_type_names:  dict of all possible filter settings - ranges for the filter parameters along with the filter type names
    ...
    def create_end_to_end_all_proc_vars_combinations(self, dict_param_names_and_ranges, root_filename="eq-ed",
        ...
        if len(dict_param_names_and_ranges) == number_of_filters:  # TODO test this if
            ...
            dict_filenames_and_process_variants = self._create_all_proc_vars_combinations(
    ...
    def _process_signal_variant(self, signal_in, dict_procs_single_variant):
        ...
        print("line 93 preproc comp in/out", signal_in == signal_out)  # test if the signal was copied
    ...
    def process_signal_all_variants(self, signal_in, dict_filenames_and_process_variants, normalize=True):
        ...
        for filename in dict_filenames_and_process_variants:
            ...
            out_sig = self._process_signal_variant(signal_in, dict_filenames_and_process_variants[
...
signal_in, sr = sf.read('D:\PCON\Disertatie\AutoMixMaster\datasets\diverse-test\white-noise-mono.wav')
# signal_in, sr = sf.read('eq_ed_20.wav')
# signal_in, sr = sf.read('c_eq_ed_10-20.wav')

aas = SignalProcessor(sr)

# Usage tips: You need to add numbers at the end of every signal processing type, because you can have multiple of the same type
...
# Change this to the number of filters you want to use or None to use all possible combinations of filters, any number of filters.
